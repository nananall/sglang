...
class DecodePreallocQueue:
    ...
    def _pre_alloc(
        ...
        # codeflicker-fix: LOGIC-Issue-001/s5iela9m6lrqwnrb1ilf
    ...
    def get_new_prebuilt_batch(self: Scheduler) -> Optional[ScheduleBatch]:
        ...
        for i in range(len(self.waiting_queue)):
            ...
            if i < num_not_used_batch:
                ...
                # codeflicker-fix: MAINT-Issue-002/s5iela9m6lrqwnrb1ilf
                ...
                # This is a safety no-op on the radix-cache path: _pre_alloc already
                # truncated fill_ids during pop_preallocated. On non-radix paths
                # (e.g., regular decode) fill_ids may grow between iterations.
