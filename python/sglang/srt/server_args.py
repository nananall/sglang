...
class ServerArgs:
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            "--enable-hisparse",
            action="store_true",
            help="Enable HiSparse hierarchical sparse KV cache for NSA decode.",
        )
        parser.add_argument(
            "--hisparse-config",
            type=str,
            default=ServerArgs.hisparse_config,
            help='HiSparse configuration in JSON format. Example: \'{"algorithm":"quest","backend":"flashattention","top_k":2048,"device_buffer_size":4096,"host_to_device_ratio":2}\'',
        )
